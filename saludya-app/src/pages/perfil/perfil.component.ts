...
export class PerfilComponent implements OnInit {
  ...
  get tieneUpper(): boolean { return /[A-Z]/.test(this.nuevaContrasena); }
  get tieneNumero(): boolean { return /[0-9]/.test(this.nuevaContrasena); }
  get passwordsCoinciden(): boolean { return this.nuevaContrasena === this.confirmarContrasena && this.nuevaContrasena.length > 0; }

  get passwordFormValido(): boolean {
    return this.contrasenaActual.length > 0
